...
$LANG['cn'] = array(
    ...
    'download'  => '下载',
    'restore'  => '恢复',
    'configure restore settings'  => '还原数据',
    'stop'  => '停止',
    'start'  => '开始',
    'restart'  => '重启',
    'update'  => '更新',
    ...
    'Owner' => '归属',
    'Users'  => '用户',
    'Load Average'  => '平均负载统计图',
    'Memory Usage'  => '内存使用统计图',
    'HTTPD Usage'  => 'apache使用统计图',
    'NGINX Usage'  => 'nginx使用统计图',
    'MySQL Usage on localhost'  => '本地Mysql使用',
    'PostgreSQL Usage on localhost'  => '本地PostgreSQL使用',
    'Bandwidth Usage eth0'  => '网卡eth0的流量统计',
    'Bandwidth Usage venet0'  => '网卡venet0的流量统计',
    'Bandwidth Usage em1'  => '网卡em1的流量统计',
    'FTP Usage'  => 'FTP使用统计图',
    'SSH Usage'  => 'SSH使用统计图',
    'reverse proxy'  => '反向代理',
    'web server'  => '网页服务器',
